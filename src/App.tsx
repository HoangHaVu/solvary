...
import OfferDemoPage from "./pages/OfferDemoPage";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/angebot-demo" element={<OfferDemoPage />} />
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              allowedRoles={["owner", "backoffice", "super_employee"]}
            >
              <CompletedOrdersPage />
            </ProtectedRoute>
          }
