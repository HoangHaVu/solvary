        ...
        <div className="max-w-[1200px] mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-brand-secondary-hover border border-white/5 rounded-xl px-4 py-2.5">
              ...
              <button className="w-9 h-9 rounded-xl bg-brand-secondary-hover border border-white/5 flex items-center justify-center text-gray-500 hover:text-white">
                      ...
                      {filteredLeads.map((lead) => (
                        ...
                        >
                          ...
                          <td className="py-4 px-2">
                            <div className="flex items-center gap-3">
                              <div className="w-8 h-8 rounded-full bg-brand-secondary flex items-center justify-center text-[10px] font-bold text-white">
