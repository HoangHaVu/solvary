...
export default function AdminSettings() {
  ...
  const tabs = [
    { id: "abo" as const, label: t("adminSettings.tabs.abo") },
    { id: "profil" as const, label: t("adminSettings.tabs.profile") },
    { id: "kalkulation" as const, label: t("adminSettings.tabs.calculation") },
    { id: "rechtliches" as const, label: t("adminSettings.tabs.legal") },
    { id: "vorlagen" as const, label: t("adminSettings.tabs.templates") },
    { id: "vorschauen" as const, label: t("adminSettings.tabs.previews") },
    { id: "integration" as const, label: t("adminSettings.tabs.integration") },
  ];
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(({ data }) => {
        ...
        if (
          data.calc_assumptions &&
          typeof data.calc_assumptions === "object"
        ) {
        ...
        if (data.offer_text_template) {
          setOfferTextTemplate((prev) => ({
            ...prev,
            ...(data.offer_text_template as Partial<OfferTextTemplate>),
          }));
        }
        if (data.email_template) {
          setEmailTemplate((prev) => ({
            ...prev,
            ...(data.email_template as Partial<EmailTemplate>),
          }));
        }
      });
  }, [user]);
  ...
  const previewLead = useMemo((): Lead => {
    ...
    const savings = Math.round(
      annualProd * eigenRate * strompreisEuro +
        annualProd * (1 - eigenRate) * 0.082,
    );
    ...
    const investment = Math.round(
      (modPrice + invPrice) * kwp + mounting + electrical,
    );
    const amort =
      savings > 0 ? Math.round((investment / savings) * 10) / 10 : 12;
    return {
      id: "preview-mock",
      first_name: "Max",
      ...
      has_heat_pump: false,
      has_battery: false,
      electricity_price: strompreisEuro,
      kwp,
      investment,
      annual_savings: savings,
      amortization: amort,
      autarky: Math.round(eigenRate * 100),
      profit_20_years: Math.round(savings * 20 - investment),
      score: null,
      planning_horizon: null,
      needs_financing: null,
      wants_zoom_call: null,
      status: "angebot",
  ...
  const previewDraft = useMemo((): OfferDraft => {
    ...
    const inverter =
      settings.wechselrichterHersteller?.split(",")[0]?.trim() || "Standard";
    return {
      id: "preview-draft",
      lead_id: "preview-mock",
      ...
      line_items: [
        {
          id: "p1",
          offer_draft_id: "preview-draft",
          category: "module",
          description: `Solarmodule ${panel} · ${kwp} kWp`,
          quantity: kwp,
          unit: "kWp",
          unit_price: modPrice,
          total_price: modTotal,
          is_optional: false,
          sort_order: 1,
        },
        {
        ...
        },
        {
          ...
          quantity: 1,
          unit: "Pausch.",
          unit_price: electrical,
          total_price: electrical,
          is_optional: false,
          sort_order: 4,
        },
      ],
                ...
                <div className="lg:col-span-2 bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.subscription.title")}
                    </h3>
                    <span className="ml-auto text-xs px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 font-medium">
                      {t("adminSettings.subscription.active")}
                    </span>
                  </div>
                  <div className="px-6 py-6">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <p className="text-xs text-gray-500 mb-1">
                          {t("adminSettings.subscription.currentPackage")}
                        </p>
                        <p className="text-xl font-bold text-white">
                          Professional
                        </p>
                        <p className="text-xs text-gray-500">
                          {t("adminSettings.subscription.planDetails", {
                            price: 299,
                            users: 5,
                          })}
                        </p>
                      ...
                      <button className="px-5 py-2.5 bg-brand-primary text-brand-secondary rounded-xl text-sm font-bold hover:bg-brand-primary-hover transition-colors">
                        {t("adminSettings.subscription.upgrade")}
                      </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="bg-[#252525]/50 rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xs text-gray-500">
                            {t("adminSettings.subscription.leadsThisMonth")}
                          </span>
                        ...
                        <p className="text-xs text-gray-500 mt-1.5">
                          {t("adminSettings.subscription.leadsCreated", {
                            count: 12,
                          })}
                        </p>
                      </div>
                      ...
                      <div className="bg-[#252525]/50 rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xs text-gray-500">
                            {t("adminSettings.subscription.teamMembers")}
                          </span>
                        ...
                        <p className="text-xs text-gray-500 mt-1.5">
                          {t("adminSettings.subscription.seatsLeft", {
                            count: 4,
                          })}
                        </p>
                      </div>
                      ...
                      <div className="bg-[#252525]/50 rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xs text-gray-500">
                            {t("adminSettings.subscription.features")}
                          </span>
                        ...
                        <p className="text-xs text-gray-500 mt-1.5">
                          {[
                            t(
                              "adminSettings.subscription.featureList.calendar",
                            ),
                            t(
                              "adminSettings.subscription.featureList.crmWebhook",
                            ),
                            t(
                              "adminSettings.subscription.featureList.leadScoring",
                            ),
                          ].join(", ")}
                        </p>
                      </div>
                    ...
                    <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {[
                        {
                          label: t(
                            "adminSettings.subscription.featureList.configurator",
                          ),
                          active: true,
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.leadPipeline",
                          ),
                          active: true,
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.projects",
                          ),
                          active: true,
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.offerPdf",
                          ),
                          active: true,
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.invoicePdf",
                          ),
                          active: true,
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.messages",
                          ),
                          active: true,
                        },
                        {
                        ...
                        {
                          label: t(
                            "adminSettings.subscription.featureList.customDomain",
                          ),
                          active: false,
                          tier: "Enterprise",
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.apiAccess",
                          ),
                          active: false,
                          tier: "Enterprise",
                        },
                        {
                          label: t(
                            "adminSettings.subscription.featureList.multiLocation",
                          ),
                          active: false,
                          tier: "Enterprise",
                        },
                        ...
                        >
                          <div
                            className={`w-1.5 h-1.5 rounded-full ${feat.active ? "bg-emerald-400" : "bg-gray-600"}`}
                          />
                          {feat.label}
                          {!feat.active && (
              ...
              <>
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.profile.publicProfile")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <div className="space-y-2">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.profile.profileLink")}
                      </label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.companyNamePublic")}
                        </label>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.website")}
                        </label>
                        <div className="relative">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.profile.whiteLabelSlug")}
                        <span className="ml-2 text-[10px] bg-blue-500/10 text-blue-400 border border-blue-500/20 px-1.5 py-0.5 rounded-full">
                          {t("adminSettings.profile.whiteLabelBadge")}
                        </span>
                      </label>
                      <div className="flex items-center gap-2">
                      ...
                      <p className="text-[10px] text-gray-600">
                        {t("adminSettings.profile.slugHint")}
                      </p>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.profile.bio")}
                      </label>
                      <div className="relative">
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.profile.companyProfile")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <div className="space-y-3">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.profile.companyLogo")}
                      </label>
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          >
                            ...
                            {t("adminSettings.profile.uploadLogo")}
                          </button>
                          {settings.logoDataUrl && (
                            <button
                              onClick={resetLogo}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.companyName")}
                        </label>
                        <input
                          type="text"
                          value={settings.firmenname}
                          onChange={(e) =>
                            updateSetting("firmenname", e.target.value)
                          }
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.slogan")}
                        </label>
                        <input
                          type="text"
                          value={settings.slogan}
                          onChange={(e) =>
                            updateSetting("slogan", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden lg:col-span-2">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.profile.brandingColors")}
                    </h3>
                  </div>
                  <div className="px-6 py-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.primaryColor")}
                        </label>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.profile.accentColor")}
                        </label>
                        <div className="flex items-center gap-3">
                          <input
                            type="color"
                    ...
                    <div className="mt-5 rounded-lg border border-white/10 overflow-hidden">
                      ...
                      >
                        {settings.firmenname ||
                          t("adminSettings.common.yourCompanyName")}
                      </div>
                      <div className="px-5 py-3 bg-[#252525] flex items-center gap-3">
                        ...
                        >
                          {t("adminSettings.profile.offerCreatedBadge")}
                        </span>
                        <span className="text-xs text-gray-500">
                          {t("adminSettings.profile.colorPreview")}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <>
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.calculation.configuratorAssumptions")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <p className="text-xs text-gray-400 leading-relaxed">
                      {t(
                        "adminSettings.calculation.configuratorAssumptionsDescription",
                      )}
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.guidelinePrice")}
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateAssumption("investPerKwp", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            placeholder={t(
                              "adminSettings.calculation.defaultPlaceholder",
                              { value: 1800 },
                            )}
                            min="0"
                            step="50"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t(
                            "adminSettings.calculation.electricityPriceDefault",
                          )}
                        </label>
                        <div className="relative">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.feedInTariff")}
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateAssumption("feedInTariff", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            placeholder={t(
                              "adminSettings.calculation.defaultPlaceholder",
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.maintenanceCosts")}
                        </label>
                        <div className="relative">
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.calculation.offerConfig")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.minPrice")}
                        </label>
                        <div className="relative">
                          <Euro className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("mindestpreis", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="500"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.defaultMargin")}
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("marge", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            max="100"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.defaultIban")}
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            value={settings.iban}
                            onChange={(e) =>
                              updateSetting("iban", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.paymentTermDays")}
                        </label>
                        <div className="relative">
                          <Clock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("zahlungsziel", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            max="90"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.calculation.panelManufacturer")}
                      </label>
                      <input
                        type="text"
                        value={settings.panelHersteller}
                        onChange={(e) =>
                          updateSetting("panelHersteller", e.target.value)
                        }
                        className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.calculation.inverterManufacturer")}
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="pt-4 border-t border-white/5">
                      <p className="text-xs font-medium text-gray-400 mb-3">
                        {t("adminSettings.calculation.defaultOfferPrices")}
                      </p>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.modules")}
                          </label>
                          <input
                            type="number"
                            value={settings.modulePricePerKwp}
                            onChange={(e) =>
                              updateSetting("modulePricePerKwp", e.target.value)
                            }
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.inverter")}
                          </label>
                          <input
                            type="number"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.storage")}
                          </label>
                          <input
                            type="number"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.mounting")}
                          </label>
                          <input
                            type="number"
                            value={settings.mountingFixed}
                            onChange={(e) =>
                              updateSetting("mountingFixed", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="100"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.electrical")}
                          </label>
                          <input
                            type="number"
                            value={settings.electricalFixed}
                            onChange={(e) =>
                              updateSetting("electricalFixed", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="100"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.scaffolding")}
                          </label>
                          <input
                            type="number"
                            value={settings.scaffoldingFixed}
                            onChange={(e) =>
                              updateSetting("scaffoldingFixed", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="100"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.travel")}
                          </label>
                          <input
                            type="number"
                            value={settings.travelFixed}
                            onChange={(e) =>
                              updateSetting("travelFixed", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="50"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-[10px] text-gray-500">
                            {t("adminSettings.calculation.vatRate")}
                          </label>
                          <input
                            type="number"
                            value={settings.vatRate}
                            onChange={(e) =>
                              updateSetting("vatRate", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            max="100"
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    <Calculator className="w-5 h-5 text-brand-primary" />
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.calculation.calculationParameters")}
                    </h3>
                  </div>
                  <div className="px-6 py-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.electricityPrice")}
                        </label>
                        <div className="relative">
                          <TrendingUp className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("strompreis", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="0.5"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t(
                            "adminSettings.calculation.electricityPriceIncrease",
                          )}
                        </label>
                        <div className="relative">
                          <Percent className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.kfwInterestRate")}
                        </label>
                        <div className="relative">
                          <Percent className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("kfwZinssatz", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            step="0.05"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.selfConsumptionRate")}
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateSetting("eigenverbrauch", e.target.value)
                            }
                            className="w-full bg-[#252525] border border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                            min="0"
                            max="100"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.calculation.co2Factor")}
                        </label>
                        <input
                          type="number"
                          value={settings.co2Faktor}
                          onChange={(e) =>
                            updateSetting("co2Faktor", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                          min="0"
                          step="0.01"
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.calculation.regionAvailability")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.calculation.servedZipAreas")}
                      </label>
                      <textarea
                        value={settings.plzGebiete}
                        onChange={(e) =>
                          updateSetting("plzGebiete", e.target.value)
                        }
                      ...
                      />
                      <p className="text-xs text-gray-500">
                        {t("adminSettings.calculation.zipHint")}
                      </p>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.calculation.maxDistance")}
                      </label>
                      <input
                        type="number"
                        value={settings.maxEntfernung}
                        onChange={(e) =>
                          updateSetting("maxEntfernung", e.target.value)
                        }
                        className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                        min="0"
                        step="5"
              ...
              <>
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    <CreditCard className="w-5 h-5 text-brand-primary" />
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.legal.legalRequirements")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.legal.taxNumber")}
                        </label>
                        <input
                          type="text"
                          value={settings.steuernummer}
                          onChange={(e) =>
                            updateSetting("steuernummer", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.legal.invoiceNumberRange")}
                        </label>
                        <input
                          type="text"
                          value={settings.rechnungskreis}
                          onChange={(e) =>
                            updateSetting("rechnungskreis", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                          placeholder="RE"
                        />
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.legal.street")}
                        </label>
                        <input
                          type="text"
                          value={settings.adresse}
                          onChange={(e) =>
                            updateSetting("adresse", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.legal.managingDirector")}
                        </label>
                        <input
                          type="text"
                          value={settings.geschaeftsfuehrer}
                          onChange={(e) =>
                            updateSetting("geschaeftsfuehrer", e.target.value)
                          }
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50"
              ...
              <>
                ...
                <div className="lg:col-span-2 bg-brand-secondary-hover rounded-2xl border border-white/5 p-5">
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">
                    {t("adminSettings.templates.availablePlaceholders")}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {(
                      [
                        [
                          "{{vorname}}",
                          t("adminSettings.templates.placeholders.firstName"),
                        ],
                        [
                          "{{nachname}}",
                          t("adminSettings.templates.placeholders.lastName"),
                        ],
                        [
                          "{{angebotsnummer}}",
                          t("adminSettings.templates.placeholders.offerNumber"),
                        ],
                        [
                          "{{firmenname}}",
                          t("adminSettings.templates.placeholders.companyName"),
                        ],
                        [
                          "{{datum}}",
                          t("adminSettings.templates.placeholders.date"),
                        ],
                        [
                          "{{gueltig_bis}}",
                          t("adminSettings.templates.placeholders.validUntil"),
                        ],
                        [
                          "{{zahlungsziel}}",
                          t("adminSettings.templates.placeholders.paymentTerm"),
                        ],
                      ] as [string, string][]
                    ).map(([ph, desc]) => (
                      <div
                        key={ph}
                        className="flex items-center gap-1.5 bg-[#252525] border border-white/5 rounded-lg px-2.5 py-1.5"
                      >
                        <code className="text-[10px] text-brand-primary font-mono">
                          {ph}
                        </code>
                ...
                <div className="lg:col-span-2 bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-white">
                        {t("adminSettings.templates.offerTemplateTitle")}
                      </h3>
                      <p className="text-xs text-gray-500 mt-0.5">
                        {t("adminSettings.templates.offerTemplateHint")}
                      </p>
                    </div>
                  </div>
                  <div className="px-6 py-6 space-y-6">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.templates.salutation")}
                      </label>
                      <p className="text-[10px] text-gray-600">
                        {t("adminSettings.templates.salutationHint")}
                      </p>
                      <textarea
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.templates.terms")}
                      </label>
                      <textarea
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        <label className="text-xs font-medium text-gray-400">
                          {t("adminSettings.templates.showFollowUpCosts")}
                        </label>
                        <input
                          type="checkbox"
                          ...
                          onChange={(e) =>
                            setOfferTextTemplate((prev) => ({
                              ...prev,
                              showFolgekosten: e.target.checked,
                            }))
                          }
                      ...
                      {offerTextTemplate.showFolgekosten && (
                        <textarea
                          ...
                          onChange={(e) =>
                            setOfferTextTemplate((prev) => ({
                              ...prev,
                              folgekostenHinweis: e.target.value,
                            }))
                          }
                          rows={5}
                          className="w-full bg-[#252525] border border-white/10 rounded-lg px-4 py-3 text-xs text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-primary/50 resize-y font-mono"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.templates.closingText")}
                      </label>
                      <p className="text-[10px] text-gray-600">
                        {t("adminSettings.templates.closingTextHint")}
                      </p>
                      <textarea
                ...
                <div className="lg:col-span-2 bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-white">
                        {t("adminSettings.templates.emailTemplate")}
                      </h3>
                      <p className="text-xs text-gray-500 mt-0.5">
                        {t("adminSettings.templates.emailTemplateHint")}
                      </p>
                    </div>
                  </div>
                  <div className="px-6 py-6 space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.templates.subject")}
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-medium text-gray-400">
                        {t("adminSettings.templates.message")}
                      </label>
                      <textarea
              ...
              <>
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center justify-between px-6 py-5 border-b border-white/5">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-sm font-semibold text-white">
                        {t("adminSettings.previews.offerPreview")}
                      </h3>
                    </div>
                    <p className="text-xs text-gray-500">
                      {t("adminSettings.previews.offerPreviewHint")}
                    </p>
                  </div>
                ...
                <div className="bg-brand-secondary-hover rounded-2xl border border-white/5 overflow-hidden">
                  <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                    ...
                    <h3 className="text-sm font-semibold text-white">
                      {t("adminSettings.previews.invoicePreview")}
                    </h3>
                  </div>
                  <div className="px-6 py-6 bg-[#0F0F0F]">
                    <p className="text-xs text-gray-500 text-center mb-5">
                      {t("adminSettings.previews.invoicePreviewHint")}
                    </p>
                    <InvoicePreviewCard
                      firmenname={settings.firmenname}
                      slogan={settings.slogan}
